...
load(here::here(base_folder, "course_urls.RData"))
les <- 1
...
knitr::include_graphics(
  here::here(base_folder, "images", "01_10_Open_Project_1.jpg"))
```
 ...
 * Directly in the R console  (the code is not saved) - so probably not a good idea as a standard practice
...
In contrast to R scripts, your code will be lost if you directly enter and execute the code in the R console. 
...
```{r, eval=F}
#marital_status <- readRDS(here::here(
#  base_folder,
#  "data",
#  "lesson1_exercise_8.2.rds"))
```

```{r, include=F}
marital_status <- read_rds(
  here::here(
  base_folder,
  "data",
  "lesson1_exercise_8.2.rds"))
...
cat(htmltools::includeText(
  here::here(
    base_folder,
    "rmarkdown",
    "lesson1_example1.Rmd")))
```
